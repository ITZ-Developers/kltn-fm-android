package com.finance.ui.task.detail.adapter;
...
import com.finance.databinding.ItemSubTaskBinding;
...
public class SubTaskAdapter extends RecyclerView.Adapter<SubTaskAdapter.SubTaskViewHolder>
{
    ...
    public SubTaskAdapter(List<TaskResponse> mListTaskResponse, OnItemClickListener onItemClickListener) {
    ...
    public SubTaskViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new SubTaskViewHolder(ItemSubTaskBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false));
    }
