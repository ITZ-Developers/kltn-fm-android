...
public interface ApiService {
    ...
    @GET("v1/file/download/{folder}/{fileName}")
    ...
    Observable<ResponseWrapper<KeyResponse>> getKeyDetail(@Path("id") Long id);
    ...
    Observable<ResponseWrapper<KeyGroupResponse>> getKeyGroupDetail(@Path("id") Long id);
