...
public final class DialogLogoutBinding implements ViewBinding {
  ...
  private DialogLogoutBinding(@NonNull LinearLayout rootView, @NonNull Button btnCancel,
      @NonNull Button btnSignout) {
  ...
  public static DialogLogoutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DialogLogoutBinding((LinearLayout) rootView, btnCancel, btnSignout);
    }
