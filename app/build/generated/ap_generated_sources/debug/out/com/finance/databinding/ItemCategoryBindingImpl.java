...
public class ItemCategoryBindingImpl extends ItemCategoryBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.secretKey == variableId) {
            ...
            setIvm((com.finance.data.model.api.response.category.CateResponse) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setIvm(@Nullable com.finance.data.model.api.response.category.CateResponse Ivm) {
        this.mIvm = Ivm;
        synchronized(this) {
            mDirtyFlags |= 0x2L;
        }
    ...
    protected void executeBindings() {
        ...
        com.finance.data.model.api.response.category.CateResponse ivm = mIvm;
