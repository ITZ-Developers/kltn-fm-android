...
public class FragmentTaskBindingImpl extends FragmentTaskBinding implements com.finance.generated.callback.OnClickListener.Listener {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.img_filter, 15);
    ...
    private androidx.databinding.InverseBindingListener edtSearchandroidTextAttrChanged = new androidx.databinding.InverseBindingListener() {
        ...
        public void onChange() {
            ...
            // vm
            com.finance.ui.fragment.task.TaskFragmentViewModel vm = mVm;
            // vm.textName != null
    ...
    public FragmentTaskBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 17, sIncludes, sViewsWithIds));
    }
    private FragmentTaskBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 6
            ...
            , (com.finance.databinding.LayoutEmptyDataBinding) bindings[11]
        ...
        setRootTag(root);
        // listeners
        mCallback136 = new com.finance.generated.callback.OnClickListener(this, 1);
        mCallback140 = new com.finance.generated.callback.OnClickListener(this, 5);
        mCallback137 = new com.finance.generated.callback.OnClickListener(this, 2);
        mCallback141 = new com.finance.generated.callback.OnClickListener(this, 6);
        mCallback138 = new com.finance.generated.callback.OnClickListener(this, 3);
        mCallback142 = new com.finance.generated.callback.OnClickListener(this, 7);
        mCallback139 = new com.finance.generated.callback.OnClickListener(this, 4);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.vm == variableId) {
            setVm((com.finance.ui.fragment.task.TaskFragmentViewModel) variable);
        }
        else if (BR.a == variableId) {
            setA((com.finance.ui.fragment.task.TaskFragment) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setVm(@Nullable com.finance.ui.fragment.task.TaskFragmentViewModel Vm) {
        this.mVm = Vm;
        synchronized(this) {
            mDirtyFlags |= 0x40L;
        }
    ...
    public void setA(@Nullable com.finance.ui.fragment.task.TaskFragment A) {
        this.mA = A;
        synchronized(this) {
            mDirtyFlags |= 0x80L;
        }
    ...
    protected void executeBindings() {
        ...
        java.lang.String vmTextNameGet = null;
        com.finance.ui.fragment.task.TaskFragment a = mA;
        ...
        if ((dirtyFlags & 0x100L) != 0) {
            ...
            this.btnAdd.setOnClickListener(mCallback142);
            ...
            this.layoutBack.setOnClickListener(mCallback136);
            this.layoutEmpty.setDes(getRoot().getResources().getString(R.string.data_empty));
            this.layoutFilter.setOnClickListener(mCallback140);
            this.mboundView5.setOnClickListener(mCallback137);
            this.mboundView6.setOnClickListener(mCallback138);
            this.mboundView7.setOnClickListener(mCallback139);
            this.swipeLayout.setOnClickListener(mCallback141);
        }
        if ((dirtyFlags & 0x142L) != 0) {
            // api target 1
        ...
        if ((dirtyFlags & 0x1d1L) != 0) {
            ...
            this.layoutFilter.setVisibility(vmIsSearchVmIsValidKeyBooleanFalseACheckPermissionConstantsPERMISSIONTASKLISTBooleanFalseViewVISIBLEViewGONE);
