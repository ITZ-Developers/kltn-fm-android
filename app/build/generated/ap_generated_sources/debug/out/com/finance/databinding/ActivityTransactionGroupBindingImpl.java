...
public class ActivityTransactionGroupBindingImpl extends ActivityTransactionGroupBinding implements com.finance.generated.callback.OnClickListener.Listener {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.rcv_group_transactions, 6);
    }
    // views
    // variables
    @Nullable
    ...
    public ActivityTransactionGroupBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 7, sIncludes, sViewsWithIds));
    }
    private ActivityTransactionGroupBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback143 = new com.finance.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.vm == variableId) {
            setVm((com.finance.ui.transaction.group.TransactionGroupViewModel) variable);
        }
        else if (BR.a == variableId) {
            setA((com.finance.ui.transaction.group.TransactionGroupActivity) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setVm(@Nullable com.finance.ui.transaction.group.TransactionGroupViewModel Vm) {
        this.mVm = Vm;
        synchronized(this) {
            mDirtyFlags |= 0x20L;
        }
    ...
    public void setA(@Nullable com.finance.ui.transaction.group.TransactionGroupActivity A) {
        this.mA = A;
        synchronized(this) {
            mDirtyFlags |= 0x40L;
        }
    ...
    protected void executeBindings() {
        ...
        java.lang.Boolean aCheckPermissionConstantsPERMISSIONGROUPTRANSACTIONCREATE = null;
        androidx.databinding.ObservableField<java.lang.Boolean> vmIsValidKey = null;
        boolean VmIsValidKey1 = false;
        com.finance.ui.transaction.group.TransactionGroupViewModel vm = mVm;
        ...
        com.finance.ui.transaction.group.TransactionGroupActivity a = mA;
        java.lang.Integer vmTotalElementsGet = null;
        boolean androidxDatabindingViewDataBindingSafeUnboxACheckPermissionConstantsPERMISSIONGROUPTRANSACTIONCREATE = false;
        int vmIsValidKeyACheckPermissionConstantsPERMISSIONGROUPTRANSACTIONCREATEBooleanFalseViewVISIBLEViewGONE = 0;
        boolean vmIsValidKeyACheckPermissionConstantsPERMISSIONGROUPTRANSACTIONCREATEBooleanFalse = false;
        ...
        if ((dirtyFlags & 0x20800L) != 0) {
            ...
            if ((dirtyFlags & 0x20000L) != 0) {
                    ...
                    if (a != null) {
                        // read a.checkPermission(Constants.PERMISSION_GROUP_TRANSACTION_CREATE)
                        aCheckPermissionConstantsPERMISSIONGROUPTRANSACTIONCREATE = a.checkPermission(com.finance.constant.Constants.PERMISSION_GROUP_TRANSACTION_CREATE);
                    }


                    // read androidx.databinding.ViewDataBinding.safeUnbox(a.checkPermission(Constants.PERMISSION_GROUP_TRANSACTION_CREATE))
                    androidxDatabindingViewDataBindingSafeUnboxACheckPermissionConstantsPERMISSIONGROUPTRANSACTIONCREATE = androidx.databinding.ViewDataBinding.safeUnbox(aCheckPermissionConstantsPERMISSIONGROUPTRANSACTIONCREATE);
            }
        ...
        if ((dirtyFlags & 0xe4L) != 0) {
                ...
                // read androidx.databinding.ViewDataBinding.safeUnbox(vm.isValidKey.get()) ? androidx.databinding.ViewDataBinding.safeUnbox(a.checkPermission(Constants.PERMISSION_GROUP_TRANSACTION_CREATE)) : false
                vmIsValidKeyACheckPermissionConstantsPERMISSIONGROUPTRANSACTIONCREATEBooleanFalse = ((androidxDatabindingViewDataBindingSafeUnboxVmIsValidKeyGet) ? (androidxDatabindingViewDataBindingSafeUnboxACheckPermissionConstantsPERMISSIONGROUPTRANSACTIONCREATE) : (false));
            if((dirtyFlags & 0xe4L) != 0) {
                if(vmIsValidKeyACheckPermissionConstantsPERMISSIONGROUPTRANSACTIONCREATEBooleanFalse) {
                        dirtyFlags |= 0x8000L;
                }
                else {
                        dirtyFlags |= 0x4000L;
                ...
                // read androidx.databinding.ViewDataBinding.safeUnbox(vm.isValidKey.get()) ? androidx.databinding.ViewDataBinding.safeUnbox(a.checkPermission(Constants.PERMISSION_GROUP_TRANSACTION_CREATE)) : false ? View.VISIBLE : View.GONE
                vmIsValidKeyACheckPermissionConstantsPERMISSIONGROUPTRANSACTIONCREATEBooleanFalseViewVISIBLEViewGONE = ((vmIsValidKeyACheckPermissionConstantsPERMISSIONGROUPTRANSACTIONCREATEBooleanFalse) ? (android.view.View.VISIBLE) : (android.view.View.GONE));
        }
        // batch finished
        ...
        if ((dirtyFlags & 0x80L) != 0) {
            ...
            this.btnAdd.setOnClickListener(mCallback143);
            this.layoutHeader.setTitle(getRoot().getResources().getString(R.string.group_transaction_management));
            this.layoutInvalidKey.setDes(getRoot().getResources().getString(R.string.invalid_key));
        }
        if ((dirtyFlags & 0xe4L) != 0) {
            // api target 1

            this.btnAdd.setVisibility(vmIsValidKeyACheckPermissionConstantsPERMISSIONGROUPTRANSACTIONCREATEBooleanFalseViewVISIBLEViewGONE);
        }
        if ((dirtyFlags & 0xc0L) != 0) {
            // api target 1
    ...
    /* flag mapping
        ...
        flag 14 (0xfL): androidx.databinding.ViewDataBinding.safeUnbox(vm.isValidKey.get()) ? androidx.databinding.ViewDataBinding.safeUnbox(a.checkPermission(Constants.PERMISSION_GROUP_TRANSACTION_CREATE)) : false ? View.VISIBLE : View.GONE
        flag 15 (0x10L): androidx.databinding.ViewDataBinding.safeUnbox(vm.isValidKey.get()) ? androidx.databinding.ViewDataBinding.safeUnbox(a.checkPermission(Constants.PERMISSION_GROUP_TRANSACTION_CREATE)) : false ? View.VISIBLE : View.GONE
        flag 16 (0x11L): androidx.databinding.ViewDataBinding.safeUnbox(vm.isValidKey.get()) ? androidx.databinding.ViewDataBinding.safeUnbox(a.checkPermission(Constants.PERMISSION_GROUP_TRANSACTION_CREATE)) : false
        flag 17 (0x12L): androidx.databinding.ViewDataBinding.safeUnbox(vm.isValidKey.get()) ? androidx.databinding.ViewDataBinding.safeUnbox(a.checkPermission(Constants.PERMISSION_GROUP_TRANSACTION_CREATE)) : false
