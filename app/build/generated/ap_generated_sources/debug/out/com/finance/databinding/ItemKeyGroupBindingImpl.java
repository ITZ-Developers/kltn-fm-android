...
public class ItemKeyGroupBindingImpl extends ItemKeyGroupBinding  {
    ...
    public ItemKeyGroupBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 6, sIncludes, sViewsWithIds));
    }
    private ItemKeyGroupBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.secretKey == variableId) {
            ...
            setIvm((com.finance.data.model.api.response.key.KeyGroupResponse) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setIvm(@Nullable com.finance.data.model.api.response.key.KeyGroupResponse Ivm) {
        this.mIvm = Ivm;
        synchronized(this) {
            mDirtyFlags |= 0x2L;
        }
    ...
    protected void executeBindings() {
        ...
        com.finance.data.model.api.response.key.KeyGroupResponse ivm = mIvm;
